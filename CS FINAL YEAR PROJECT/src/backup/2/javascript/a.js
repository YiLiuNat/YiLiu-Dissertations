...
(function(f, e) {
	function a() {
		...
		var k = ["Android", "iPhone", "SymbianOS", "Windows Phone", "iPad", "iPod"];
	...
	f.addEventListener("DOMContentLoaded", b, false);
	if (typeof(WeixinJSBridge) == "undefined") {
		document.addEventListener("WeixinJSBridgeReady", function(h) {
			setTimeout(function() {
